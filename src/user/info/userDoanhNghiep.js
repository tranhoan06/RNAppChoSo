...
const userDoanhNghiep = ({ navigation }) => {
  const replaceNav = () => {
    navigation.goBack();
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.contentTitle}>Thông tin doanh nghiệp</Text>
        <View style={styles.contentDetails}>
          <View style={styles.contentItem}>
            <Text>Tên doanh nghiệp</Text>
            <Text>Công ty Không Biết</Text>
          </View>

          <View style={styles.contentItem}>
            <Text>Tên DN nước ngoài</Text>
            <Text>KhongBietTechCompany</Text>
          </View>

          <View style={styles.contentItem}>
            <Text>Mã số doanh nghiệp</Text>
            <Text></Text>
          </View>
...
export default userDoanhNghiep;
